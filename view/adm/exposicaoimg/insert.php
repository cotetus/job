<form enctype="multipart/form-data" method="POST" action="?c=exposicaoimg&a=Guardar"  id="edit" tabindex="-1"   >
    ...
    <div class="modal-content">
        ...
        <div class="form-group">
        <select class="form-control " name="id_exposicao"/>
        <option value ="">Exposicao</option>
        <?php
        foreach($this->exposicao->listAll() as $item){
