...
<html lang="en" class="no-js"> 
    ...
    <body id="body">
            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul id="nav" class="nav navbar-nav">
						...
						<li><a href="#school">Museu nas Escolas</a></li>
						<li><a href="#exhibitions">Exposições</a></li>
						<li><a href="#collection">Acervo</a></li>
		...
		<section id="exhibitions" class="features clearfix">
			<div class="container">
				<div class="row">
		...
		<section id="collection" class="works clearfix" style="padding:50px 0">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row mb50">
					...
					<div class="sec-sub-title text-center wow rubberBand animated" data-wow-duration="1000ms">
						<p>Entre em contato para obter maiores informações sobre o museu, seu acervo e para organizarmos algumas exposições. Duvidas, criticas e até mesmo elogios sempre serão bem-vindos!</p>
					</div>
					
					<div class="col-lg-11 col-md-11 col-sm-11 col-xs-12 wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="300ms">
						<div class="contact-form">
							...
							<form action="#" id="contact-form">
								...
								<div class="input-group">
									<textarea name="message" id="message" placeholder="Mensagem" class="form-control"></textarea>
								</div>
								<div class="input-group">
					...
					<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 wow fadeInRight animated" data-wow-duration="500ms" data-wow-delay="600ms">
						<ul class="footer-social">
							<li><a href="http://www.museosinfronteras.com/"><i class="fa fa-dribbble fa-2x"></i></a></li>
							<li><a href="https://www.facebook.com/MuseoSinFronteras/"><i class="fa fa-facebook fa-2x"></i></a></li>
						</ul>
					</div>
